...
| Symptom | Action |
|---|---|
| User says "convert this markdown to HTML" for the first time in this workspace | Run `python3 .claude/skills/design-system/scripts/onboard.py` |
...
python3 .claude/skills/design-system/scripts/onboard.py
