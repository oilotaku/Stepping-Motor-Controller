...
```bash
python3 .claude/skills/md-document/scripts/html_renderer.py --sample \
  | python3 .claude/skills/md-document/scripts/interactivity_injector.py \
